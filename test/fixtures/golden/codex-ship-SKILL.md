...
SAWYER_SKILL_AUTOPILOT=$($GSTACK_BIN/gstack-config get sawyer_skill_autopilot 2>/dev/null || echo "off")
...
```bash
$GSTACK_BIN/gstack-sawyer-skill-autopilot --json '{"prompt":"USER_PROMPT_OR_SUMMARY","lastSkill":"SKILL_NAME_IF_ANY","lastOutcome":"OUTCOME_IF_ANY","prState":"OPEN_OR_MERGED_IF_KNOWN","deployStatus":"HEALTHY_OR_UNKNOWN","runtimeProof":"present|missing|unknown","docsChanged":false,"developerFacing":false}'
```
